...
def DrawBoard(number, thesecondone, hold, score, punishment, FONTCOLOR = WHITE, BACKCOLOR = BACK_GROUND_COLOR, TEXT_FONT = 20):
    global BLOCK_GAP, BOARDWIDTH, BOARD_SPACE, BOARD_UP, RECT_BOARD1, RECT_BOARD2, BLOCK_SIZE,nowtime
    if number == 1:
        Allblocks = Allblocks1
    ...
    '''
    textSurfaceObjTime = fontObj.render(str(nowtime), True, FONTCOLOR,BACKCOLOR)
    textRectObjTime = textSurfaceObjTime.get_rect()
    textRectObjTime.center = (WINDOWWIDTH/2,50)
