    ...
    while True:
        ...
        while len(trial_2) > 0:
            if trial_2[i] == 'Q' :
                ...
                if option_check(droppingblock2, Allblocks2) and option_check(droppingblock_2, Allblocks2):   
                    _unhold = computer(droppingblock2, Allblocks2)
                    ...
                    if option_check(droppingblock2, Allblocks2) == True:
                        trial_2 = computer(droppingblock2, Allblocks2)[0]
                        
                    elif option_check(droppingblock_2, Allblocks2) == True:
