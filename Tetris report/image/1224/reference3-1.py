...
#'I','J','L','O', 'S', 'T', 'Z'
def main():
    global DISPLAYSURF, Allblocks, score, thesecondone, hold
    pygame.init()
    score = 0
    ...
    _unhold = computer(droppingblock, Allblocks)
    _hold = computer(Tetris(thesecondone), Allblocks)
